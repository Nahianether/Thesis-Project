...
class Demo2 extends JFrame { 
    ...
    { 
        ...
        jRadioButton1 = new JRadioButton("User Information"); 
  
        // Initialization of object of "JRadioButton" class. 
        jRadioButton2 = new JRadioButton("Pay Bill"); 
     ...
     //   jRadioButton2.setText("VIP"); 
       ...
       /* payment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) { 
                            RadioButton pay=new RadioButton();
                            pay.userpayment();
			}
		});
  */
        ...
        jButton.addActionListener(new ActionListener() { 
            ...
            { 
                ...
                //   VipPaymentCacuation vip=new VipPaymentCacuation(); 
                  //  vip.calculation();  
                	if(SelectVip.typ==1)
                	{ 
                		PaymentPrepaid pre=new PaymentPrepaid(); 
                		
                		pre.prepaid();
                	} 
                	else if(SelectVip.typ==2)
                	{ 
                		PaymentPostpaid post=new PaymentPostpaid();  
                		post.postpaid();
